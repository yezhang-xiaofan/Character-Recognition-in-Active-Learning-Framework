% automatically optimize the weight using the initially 10 hand picked good
% landmarks
% use complete DP and narrower DP (width = 6)
numPixel = 28;
numEle = 40;      %number of examples of each class
      %total example * dimension of image
numLanM = 1;      %number of landmarks for each class
