    ...
    for i = 1:numEle*10,
        if(predict_label(i)~=training_label_vector(i)),
           ...
           %{
            ...
            %display the back up landmarks for top 3 landmarks for correct
            %class
            
            %{
            classLan_incorrect = information{k,1}.top3_landmarks_for_incorrect_class_with_datapoint(3,end);
            ...
            z1 = 10;
            z2 = 110;
            lanMatrix(10,1:end-1) = featureMatrix(z2,:);
            lanIndex() = ;
            %}
